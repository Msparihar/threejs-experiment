...
export function BlogPreview() {
  ...
  return (
    <section ref={container} className="relative py-20 md:py-32 bg-[#111] overflow-hidden">
      {/* 3D Background */}
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="blog-grid grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post, index) => (
            <div key={index} className="blog-post bg-[#1a1a1a] p-8 rounded-lg flex flex-col relative z-20">
